...
const AudienceSelect = ({
  ...
  const {loadAudience} = useAudiencePagination();
...
AudienceSelect.propTypes = propTypes;

export default AudienceSelect;

const useAudiencePagination = () => {
  const loadAudience = React.useCallback(
    async (search, prevOptions, {page}) => {
      const res = await AudienceAPIRequest.getAllAudience({
        params: {
          page,
