const en = {
  ...
  skip: 'Skip',
  skipUrl: 'Skip url',
  firstQuartile: 'First quartile url',
  midpoint: 'Midpoint url',
  thirdQuartile: 'Third quartile url',
  complete: 'Complete url',
  clickImage: 'Click image',
  clickScript: 'Click script',
  clickUrlAppendParams: 'Append params',
  variables: 'Variables',
  https: 'Https',
  ...
  impressionScript: 'Impression script',
  impressionImage: 'Impression image',
  impressionUrl: 'Impression url',
  startUrl: 'Start url',
  muteUrl: 'Mute url',
  unmuteUrl: 'Unmute url',
  pauseUrl: 'Pause url',
  resumeUrl: 'Resume url',
  rewindUrl: 'Rewind url',
  fullscreenUrl: 'Fullscreen url',
  exitFullscreenUrl: 'Exit fullscreen url',
  enter: 'Enter',
